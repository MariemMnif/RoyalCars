...
@section('contenu')
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h2 class="display-4 text-uppercase text-center mb-5">Ajouter un conducteur</h2>
            @if ($errors->any())
                ...
                <form method="POST" action="{{ route('admin.register') }}">
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                                <div class="date mb-3">
                                    <label for="date_permis" class="form-label">Date de délivration de permis</label>
                                    <div class="input-group">
                                        <input type="text" id="date_permis" name="date_permis" class="form-control p-4"
