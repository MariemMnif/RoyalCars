                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                            ...
                            @foreach ($supplements as $supplement)
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-4 mt-2 align-self-center">
                                        ...
                                        <span class="text-uppercase text-center">{{ $supplement->prix }} TND par jour</span>
                                    </div>
                                            ...
                                            @if ($supplement->nbMax > 1)
                                                <div class="d-flex">
                                                    ...
                                                    <input type="text" name="supplement[{{ $supplement->id }}]"
                                                        ...
                                                        id="quantite-{{ $supplement->id }}"
                                                        value="{{ $reservation->supplements->firstWhere('id', $supplement->id)?->pivot->quantite ?? 0 }}"
                                                        data-prix="{{ $supplement->prix }}">
                                                    <button class="btn btn-sm btn-primary plus-btn rounded-0" type="button"
                                                        id="button-increment-{{ $supplement->id }}">
                                                ...
                                                <div class="mb-2 mt-4">
                                                    ...
                                                    <label class="switch switch-green">
                                                        <input type="checkbox" name="supplement[{{ $supplement->id }}]"
                                                            ...
                                                            {{ $reservation->supplements->firstWhere('id', $supplement->id)?->pivot->quantite ?? 0 >= 1 ? 'checked' : '' }}>
                                ...
                                <input name="max" value="{{ $supplement->nbMax }}" data-max="{{ $supplement->nbMax }}"
                                    hidden />
                            @endforeach
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-6 form-group">
                                <input type="text" class="form-control p-4" id="nom" placeholder="Nom*"
                                    required="required" value="{{ old('nom', $user->first_name) }}">
                            </div>
                            <div class="col-6 form-group">
                                <input type="text" class="form-control p-4" id="prenom" placeholder="Prénom*"
                                    required="required" value="{{ old('prenom', $user->name) }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6 form-group">
                                <input type="email" class="form-control p-4" id="mail" placeholder="Votre Email*"
                                    value="{{ old('mail', $user->email) }}" required="required">
                            </div>
                            <div class="col-6 form-group">
                                <input type="tel" class="form-control p-4" id="tel" placeholder="Votre téléphone*"
                                    value="{{ old('tel', $user->telephone) }}" required="required">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6 form-group">
                                ...
                                <input type="text" id="dateNais" name="dateNais"
                                    ...
                                    value="{{ old('dateNais', $user->date_naissance) }}" />
                            </div>
                            <div class="col-6 form-group">
                                <label for="datePermis" class="form-label">Date de délivration de permis</label>
                                <input type="text" id="datePermis" name="datePermis"
                                    class="form-control p-4 datetimepicker-input" placeholder="jj/mm/aaaa"
                                    value="{{ old('datePermis', $user->date_permis) }}" />
                            </div>
                        </div>
                                    ...
                                    <div class="col-4 form-group">
                                        <div class="time mb-3" id="horaireVol" data-target-input="nearest">
                                            ...
                                            <input type="text" name="horaireVol"
                                                ...
                                                id="horaireVol"
                                                value="{{ old('horaireVol', $vol->horaire_vol ?? '') }}" />
                                        </div>
                                    </div>
                        ...
                        <div style="text-align: right;">
                            <button class="btn btn-success py-2 px-3" type="submit">Enregistrer les
                        ...
                        <div class="bg-light p-2 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="p-2">
                                    ...
                                    <p>{{ $reservation->lieu_prise }}
                                        <br>
                                        Le {{ $reservation->date_location }} à {{ $reservation->heure_location }}
                                    </p>
                                    <h6 class="mr-2">Retour :</h6>
                                    <p> {{ $reservation->lieu_retour }}<br>
                                        Le {{ $reservation->date_retour }} à {{ $reservation->heure_retour }}
                                    </p>
                                ...
                                <div class="bg-secondary py-3 px-sm-4 px-md-3 mb-4">
                                    ...
                                    <div class="d-flex justify-content-between w-100">
                                        ...
                                        <h5 class="text-white" id="totalOptions">{{ $totalSupplements }}</h5>
                                    </div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initialiser l'état du détail du vol au chargement
        ...
        // Initialiser le clockpicker pour le champ horaireVol
